...
public class LITPotsOfPlentyWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITPotsOfPlentyWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITPotsOfPlentyWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITPotsOfPlentyWLAIW/InitOutcome.xml").getDocumentElement();
